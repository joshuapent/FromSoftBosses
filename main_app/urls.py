...
urlpatterns = [
    ...
    path('cats/<int:game_id>/assign_weakness/<int:weakness_id>/', views.assign_weakness, name='assign_weakness'),
    path('cats/<int:game_id>/unassign_weakness/<int:weakness_id>/', views.unassign_weakness, name='unassign_weakness'),
